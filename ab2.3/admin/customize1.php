...
if (isset($_POST['order_customize'])) {
    ...
    //     $sql = "INSERT INTO orders(USER_ID, DRESS_ID, STATUSES, SSIZE, TOTAL_PRICE, CATEGORY , ESTIMATED_DELIVERY_DATE, ACTUAL_DELIVERY_DATE) 
    //             VALUES ('$_SESSION[USER_ID]', '$dress_id', 'PENDING', '$sizes', '$totalcost','DRESS_CUSTOMIZATION', '$estimate_date', '$actual_date')";
    // } 
    // else {
    //     $sql = "INSERT INTO orders(USER_ID, DRESS_ID, FABRIC_ID, STATUSES, SSIZE, TOTAL_PRICE, ESTIMATED_DELIVERY_DATE, ACTUAL_DELIVERY_DATE) 
    //             VALUES ('$_SESSION[USER_ID]', '$dress_id', '$fabric_id', 'PENDING', '$sizes', '$totalcost', '$estimate_date', '$actual_date')";
    // }
    ...
    if ($_SESSION["DRESS_ID"] == $dress_id) {
        ...
        $sql = "INSERT INTO orders(USER_ID, FABRIC_ID, STATUSES, SSIZE, TOTAL_PRICE, CATEGORY , ESTIMATED_DELIVERY_DATE, ACTUAL_DELIVERY_DATE) 
                VALUES ('$_SESSION[USER_ID]', '$fabric_id', 'PENDING', '$sizes', '$totalcost','FULLY_CUSTOMIZATION', '$estimate_date', '$actual_date')";
    }else if($dress_id!='none' && $fabric_id=='none'){
        $sql = "INSERT INTO orders(USER_ID, DRESS_ID, STATUSES, SSIZE, TOTAL_PRICE, CATEGORY , ESTIMATED_DELIVERY_DATE, ACTUAL_DELIVERY_DATE) 
                VALUES ('$_SESSION[USER_ID]', '$dress_id', 'PENDING', '$sizes', '$totalcost','FULLY_CUSTOMIZATION', '$estimate_date', '$actual_date')";
    }else {
        $sql = "INSERT INTO orders(USER_ID, DRESS_ID, FABRIC_ID, STATUSES, SSIZE, TOTAL_PRICE, CATEGORY , ESTIMATED_DELIVERY_DATE, ACTUAL_DELIVERY_DATE) 
                VALUES ('$_SESSION[USER_ID]', '$dress_id', '$fabric_id', 'PENDING', '$sizes', '$totalcost','FULLY_CUSTOMIZATION', '$estimate_date', '$actual_date')";
    }
    ...
    if ($odata) {
        ...
        // Insert into measurements table using the newly fetched ORDER_ID
        // if ($_SESSION["DRESS_ID"] == $dress_id) {
        //     $sql = "INSERT INTO measurements(USER_ID, DRESS_ID, ORDER_ID, SHOULDER, BUST, WAIST, HIP) 
        //             VALUES ('$_SESSION[USER_ID]', '$dress_id', '$order_id', '$shoulder', '$bust', '$waist', '$hips')";
        // } else {
        //     $sql = "INSERT INTO measurements(USER_ID, DRESS_ID, FABRIC_ID, ORDER_ID, SHOULDER, BUST, WAIST, HIP) 
        //             VALUES ('$_SESSION[USER_ID]', '$dress_id', '$fabric_id', '$order_id', '$shoulder', '$bust', '$waist', '$hips')";
        // }
        ...
        if ($measurent) {
            // Get the newly inserted MEASUREMENT_ID
            ...
            $m_id = mysqli_insert_id($conn);
                ...
                // Insert into customizations table using the MEASUREMENT_ID and ORDER_ID
                if ($_SESSION["DRESS_ID"] == $dress_id || $dress_id!='none' && $fabric_id=='none') {
                ...
                if ($cdata) {
                    // Now update the OPTION_ID in the orders table
                    ...
                    // Update the orders table with the OPTION_ID
                    $sql = "UPDATE orders SET OPTION_ID='$o_id' WHERE ORDER_ID='$order_id'";
                    $updateOrder = mysqli_query($conn, $sql);
...
if (isset($_POST['save_customize'])) {
    ...
    // Insert data into database
       ...
       if ($_SESSION["DRESS_ID"] == $dress_id) {
        $sql = "INSERT INTO orders(USER_ID, DRESS_ID, STATUSES, SSIZE, TOTAL_PRICE, CATEGORY , ESTIMATED_DELIVERY_DATE, ACTUAL_DELIVERY_DATE) 
                VALUES ('$_SESSION[USER_ID]', '$dress_id', 'CART', '$sizes', '$totalcost','DRESS_CUSTOMIZATION', '$estimate_date', '$actual_date')";
    }else if($dress_id=='none' && $fabric_id!='none'){
        $sql = "INSERT INTO orders(USER_ID, FABRIC_ID, STATUSES, SSIZE, TOTAL_PRICE, CATEGORY , ESTIMATED_DELIVERY_DATE, ACTUAL_DELIVERY_DATE) 
                VALUES ('$_SESSION[USER_ID]', '$fabric_id', 'CART', '$sizes', '$totalcost','FULLY_CUSTOMIZATION', '$estimate_date', '$actual_date')";
    }else if($dress_id!='none' && $fabric_id=='none'){
        $sql = "INSERT INTO orders(USER_ID, DRESS_ID, STATUSES, SSIZE, TOTAL_PRICE, CATEGORY , ESTIMATED_DELIVERY_DATE, ACTUAL_DELIVERY_DATE) 
                VALUES ('$_SESSION[USER_ID]', '$dress_id', 'CART', '$sizes', '$totalcost','FULLY_CUSTOMIZATION', '$estimate_date', '$actual_date')";
    }else {
        $sql = "INSERT INTO orders(USER_ID, DRESS_ID, FABRIC_ID, STATUSES, SSIZE, TOTAL_PRICE, CATEGORY , ESTIMATED_DELIVERY_DATE, ACTUAL_DELIVERY_DATE) 
                VALUES ('$_SESSION[USER_ID]', '$dress_id', '$fabric_id', 'CART', '$sizes', '$totalcost','FULLY_CUSTOMIZATION', '$estimate_date', '$actual_date')";
    }
