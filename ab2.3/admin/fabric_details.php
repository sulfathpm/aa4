...
// Place order
$sql = "INSERT INTO orders(USER_ID, FABRIC_ID, STATUSES, QUANTITY, TOTAL_PRICE, CATEGORY , ESTIMATED_DELIVERY_DATE, ACTUAL_DELIVERY_DATE) 
VALUES ('{$_SESSION['USER_ID']}', '{$_SESSION['FABRIC_ID']}', 'PENDING', '$meter', '$totalprice', 'FABRIC_PURCHASE', '$estimate_date', '$actual_date')";
        ...
        if ($meter == 0) {
            ...
            if ($meter > $stock) {
                ...
                if ($_SESSION["USER_ID"] == null) {
                    ...
                    $sql = "INSERT INTO orders(USER_ID, FABRIC_ID, STATUSES, QUANTITY, TOTAL_PRICE , CATEGORY) 
                            VALUES ('{$_SESSION['USER_ID']}', '{$_SESSION['FABRIC_ID']}', 'CART', '$meter', '$totalprice' , 'FABRIC_PURCHASE')";
