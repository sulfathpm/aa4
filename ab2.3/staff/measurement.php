...
if (isset($_POST['order_customize'])) {
    ...
    if($dress_id=='none' && $fabric_id!='none'){
        $sql = "INSERT INTO orders(USER_ID, FABRIC_ID , OPTION_ID , STATUSES, SSIZE, TOTAL_PRICE, CATEGORY , ESTIMATED_DELIVERY_DATE, ACTUAL_DELIVERY_DATE) 
                VALUES ('$user_id', '$fabric_id', '$o_id' , 'PENDING', '$sizes', '$totalcost','OFFLINE_PURCHASE', '$estimate_date', '$actual_date')";
    }else if($dress_id!='none' && $fabric_id=='none'){
        $sql = "INSERT INTO orders(USER_ID, DRESS_ID , OPTION_ID , STATUSES, SSIZE, TOTAL_PRICE, CATEGORY , ESTIMATED_DELIVERY_DATE, ACTUAL_DELIVERY_DATE) 
                VALUES ('$user_id', '$dress_id', '$o_id' , 'PENDING', '$sizes', '$totalcost','OFFLINE_PURCHASE', '$estimate_date', '$actual_date')";
    }else if($dress_id!='none' && $fabric_id!='none'){
        $sql = "INSERT INTO orders(USER_ID, DRESS_ID, FABRIC_ID , OPTION_ID , STATUSES, SSIZE, TOTAL_PRICE, CATEGORY , ESTIMATED_DELIVERY_DATE, ACTUAL_DELIVERY_DATE) 
                VALUES ('$user_id', '$dress_id', '$fabric_id', '$o_id' , 'PENDING', '$sizes', '$totalcost','OFFLINE_PURCHASE', '$estimate_date', '$actual_date')";
    }else{
        $sql = "INSERT INTO orders(USER_ID, OPTION_ID , STATUSES, SSIZE, TOTAL_PRICE, CATEGORY , ESTIMATED_DELIVERY_DATE, ACTUAL_DELIVERY_DATE) 
                VALUES ('$user_id', '$o_id' , 'PENDING', '$sizes', '$totalcost','OFFLINE_PURCHASE', '$estimate_date', '$actual_date')";
    }
