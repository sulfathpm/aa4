...
if (isset($_POST['order_customize'])) {
    ...
    if ($_SESSION["DRESS_ID"] == $dress_id) {
        $sql = "INSERT INTO orders(USER_ID, DRESS_ID , OPTION_ID , STATUSES, SSIZE, TOTAL_PRICE, CATEGORY , ESTIMATED_DELIVERY_DATE, ACTUAL_DELIVERY_DATE) 
                VALUES ('$_SESSION[USER_ID]', '$dress_id', '$o_id' , 'PENDING', '$sizes', '$totalcost','DRESS_CUSTOMIZATION', '$estimate_date', '$actual_date')";
    }else if($dress_id=='none' && $fabric_id!='none'){
        $sql = "INSERT INTO orders(USER_ID, FABRIC_ID , OPTION_ID , STATUSES, SSIZE, TOTAL_PRICE, CATEGORY , ESTIMATED_DELIVERY_DATE, ACTUAL_DELIVERY_DATE) 
                VALUES ('$_SESSION[USER_ID]', '$fabric_id', '$o_id' , 'PENDING', '$sizes', '$totalcost','FULLY_CUSTOMIZATION', '$estimate_date', '$actual_date')";
    }else if($dress_id!='none' && $fabric_id=='none'){
        $sql = "INSERT INTO orders(USER_ID, DRESS_ID , OPTION_ID , STATUSES, SSIZE, TOTAL_PRICE, CATEGORY , ESTIMATED_DELIVERY_DATE, ACTUAL_DELIVERY_DATE) 
                VALUES ('$_SESSION[USER_ID]', '$dress_id', '$o_id' , 'PENDING', '$sizes', '$totalcost','FULLY_CUSTOMIZATION', '$estimate_date', '$actual_date')";
    }else {
        $sql = "INSERT INTO orders(USER_ID, DRESS_ID, FABRIC_ID , OPTION_ID , STATUSES, SSIZE, TOTAL_PRICE, CATEGORY , ESTIMATED_DELIVERY_DATE, ACTUAL_DELIVERY_DATE) 
                VALUES ('$_SESSION[USER_ID]', '$dress_id', '$fabric_id', '$o_id' , 'PENDING', '$sizes', '$totalcost','FULLY_CUSTOMIZATION', '$estimate_date', '$actual_date')";
    }
...
if (isset($_POST['save_customize'])) {
    ...
    if ($_SESSION["DRESS_ID"] == $dress_id) {
        $sql = "INSERT INTO orders(USER_ID, DRESS_ID , OPTION_ID , STATUSES, SSIZE, TOTAL_PRICE, CATEGORY , ESTIMATED_DELIVERY_DATE, ACTUAL_DELIVERY_DATE) 
                VALUES ('$_SESSION[USER_ID]', '$dress_id', '$o_id' , 'CART', '$sizes', '$totalcost','DRESS_CUSTOMIZATION', '$estimate_date', '$actual_date')";
    }else if($dress_id=='none' && $fabric_id!='none'){
        $sql = "INSERT INTO orders(USER_ID, FABRIC_ID , OPTION_ID , STATUSES, SSIZE, TOTAL_PRICE, CATEGORY , ESTIMATED_DELIVERY_DATE, ACTUAL_DELIVERY_DATE) 
                VALUES ('$_SESSION[USER_ID]', '$fabric_id', '$o_id' , 'CART', '$sizes', '$totalcost','FULLY_CUSTOMIZATION', '$estimate_date', '$actual_date')";
    }else if($dress_id!='none' && $fabric_id=='none'){
        $sql = "INSERT INTO orders(USER_ID, DRESS_ID , OPTION_ID , STATUSES, SSIZE, TOTAL_PRICE, CATEGORY , ESTIMATED_DELIVERY_DATE, ACTUAL_DELIVERY_DATE) 
                VALUES ('$_SESSION[USER_ID]', '$dress_id', '$o_id' , 'CART', '$sizes', '$totalcost','FULLY_CUSTOMIZATION', '$estimate_date', '$actual_date')";
    }else {
        $sql = "INSERT INTO orders(USER_ID, DRESS_ID, FABRIC_ID , OPTION_ID , STATUSES, SSIZE, TOTAL_PRICE, CATEGORY , ESTIMATED_DELIVERY_DATE, ACTUAL_DELIVERY_DATE) 
                VALUES ('$_SESSION[USER_ID]', '$dress_id', '$fabric_id', '$o_id' , 'CART', '$sizes', '$totalcost','FULLY_CUSTOMIZATION', '$estimate_date', '$actual_date')";
    }
