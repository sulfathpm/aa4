...
<body>
    ...
    <div class="container">
        ...
        <div class="card-container">
            <?php
            // Modify the query to include a search condition if a search term is provided
            $fabrics_query = "SELECT * FROM fabrics WHERE is_deleted = 0";
            if (!empty($search_term)) {
                $fabrics_query .= " WHERE NAME LIKE '%$search_term%' OR DESCRIPTION LIKE '%$search_term%'";
            }
